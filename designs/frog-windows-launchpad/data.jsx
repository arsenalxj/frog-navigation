/* 青蛙导航 Windows 启动台原型 — 模拟书签数据
 * 数据结构对齐 plans/PLAN_WINDOWS.md「数据、接口与资源控制」：
 *   format: "frog-bookmarks", schemaVersion: 1, groups, bookmarks
 * 与 macOS 版完全相同的 UTF-8 JSON：保留 ID、创建时间、逻辑顺序，
 * 根目录书签 groupId 为 null，两端备份可互相读取。
 * 根目录书签与文件夹共享同一根排序序列；文件夹内书签各自有组内排序。
 * hue 字段仅用于原型演示：模拟已缓存 favicon 的低饱和底板；
 * hue 为 null 表示图标缺失，按灰阶显示首字符（对应「缺失时显示首字符」）。
 */
...
const FROG_SEED = {
  ...
  bookmarks: [
    ...
    { id: "b-notion",   title: "Notion",       url: "https://www.notion.so",    groupId: null,      order: 5,  createdAt: 1756000300000, hue: null },
    ...
    { id: "b-vercel",   title: "Vercel",       url: "https://vercel.com",       groupId: null,      order: 14, createdAt: 1756000900000, hue: null },
    ...
    { id: "b-msdocs",   title: "Win32 文档",       url: "https://learn.microsoft.com/windows/win32/", groupId: "g-dev", order: 5, createdAt: 1756010400000, hue: 205 },
...
/* 首字符底板配色：灰阶表示图标缓存缺失（首字符占位），低饱和色相模拟已缓存 favicon */
